Scary puzzle today, lots of steps, an unbound amount of steps. A suspicious lack of use of the curly brackets in the input

Plan for this is to make a combination graph/state machine type thing, and then use BFS (definately breadth first coz shortest) to traverse the graph while unsolved

I understand those components but havnt implimented them. Need to look stuff up.
